...
echo y | android update sdk --filterplatform-tools,build-tools-$ANDROID_BUILD_TOOLS_VERSION,android-$ANDROID_API_LEVEL,android-$EMULATOR_API_LEVEL,sysimg-$EMULATOR_API_LEVEL,extra-android-m2repository --no-ui --force --all > /dev/null
